    ...
    <div className="w-full lg:w-10/12 mx-auto">
      <div className="text-center mb-20">
          ...
          <p className="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-gray-500">
            Appnality’s industry leading web and app development services offers
            a seamless work flow for custom applications and websites
            development.
          </p>
        ...
        <div className="group relative cursor-pointer overflow-hidden bg-white px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl sm:mx-auto sm:max-w-sm sm:rounded-lg sm:px-10">
            ...
            <div className="relative z-10 mx-auto max-w-md">
              ...
              <h3 className="text-2xl font-bold mb-4">Inspired Ideation</h3>
                <p>
                We first brainstorm and align the initial ideas with your vision
                and mission to build the solid foundation for your E-commerce
                web project
                </p>
              </div>
            </div>
          ...
          <div className="group relative cursor-pointer overflow-hidden bg-white px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl sm:mx-auto sm:max-w-sm sm:rounded-lg sm:px-10">
            ...
            <div className="relative z-10 mx-auto max-w-md">
              ...
              <h3 className="text-2xl font-bold mb-4">Design & Development</h3>
                <p>
                Our team designs visually appealing, responsive, and functional
                platforms customized to your business needs.
                </p>
              </div>
            </div>
          </div>
